        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleExtracted = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsChecks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsChecks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SimilarArticlesCount = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnalysisReports_NewsChecks_NewsCheckId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExternalSources_NewsChecks_NewsCheckId",
                        column: x => x.NewsCheckId,
                        principalTable: "NewsChecks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManipulationScore = table.Column<float>(type: "real", nullable: false),
                    SourceOriginUrl = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaMetadatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MediaMetadatas_NewsChecks_NewsCheckId",
                        column: x => x.NewsCheckId,
                        principalTable: "NewsChecks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnalysisReports_NewsCheckId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalSources_NewsCheckId",
                table: "ExternalSources",
                column: "NewsCheckId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaMetadatas_NewsCheckId",
                table: "MediaMetadatas",
                column: "NewsCheckId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsChecks_UserId",
                table: "NewsChecks",
                column: "UserId");
        }
